...
public class Generator {
    ...
    public static void generate(Volume volume, int height, int seed) {
        ...
        for (int y = 0; y < volume.getY(); y++) {
            for (int z = 0; z < volume.getZ(); z++) {
                volume.grid[0][y][z] = Float.MAX_VALUE;
            }
        }
    ...
    private static void bound(int X, int Y, int Z, Volume.Boundary boundary, float grid[][][]) {
        ...
        for (int y = 1; y < Y - 1; y++) {
            for (int z = 1; z < Z - 1; z++) {
                grid[1][y][z] = (boundary == Volume.Boundary.X) ? -grid[1][y][z] : grid[1][y][z];
        ...
        // corner points
        grid[1][0][0] = (grid[2][0][0] + grid[1][1][0] + grid[1][0][1]) / 2;
        grid[X - 1][0][0] = (grid[X - 2][0][0] + grid[X - 1][1][0] + grid[X - 1][0][1]) / 2;
        grid[1][Y - 1][0] = (grid[2][Y - 1][0] + grid[1][Y - 2][0] + grid[1][Y - 1][1]) / 2;
        grid[1][0][Z - 1] = (grid[2][0][Z - 1] + grid[1][1][Z - 1] + grid[1][0][Z - 2]) / 2;
        ...
        grid[1][Y - 1][Z - 1] = (grid[2][Y - 1][Z - 1] + grid[1][Y - 2][Z - 1] + grid[1][Y - 1][Z - 2]) / 2;
